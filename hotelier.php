...
$query = $conn->prepare("INSERT INTO hotelier (hotelier_name, email, phone_no, passwd, conf_passwd) VALUES (?, ?, ?, ?, ?)");
$query->bind_param("sssss", $hotelier_name, $email, $phone_no, $hashedPassword, $conf_passwd);
