...
if (!isset($_POST['username'], $_POST['email'], $_POST['passwd'], $_POST['conf_passwd'])) {
    header("Location: C:/xampp/htdocs/trial2.html ");
    exit;
}
...
$query = $conn->prepare("INSERT INTO admin (username, email, phone_no, passwd) VALUES (?, ?, ?, ?)");
$query->bind_param("ssss", $username, $email, $phone_no, $hashedPassword, );
